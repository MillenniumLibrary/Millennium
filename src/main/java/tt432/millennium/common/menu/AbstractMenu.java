...
import tt432.millennium.common.menu.slot.ItemStackHandlerResultSlot;
...
public abstract class AbstractMenu extends AbstractContainerMenu {
    ...
    protected AbstractMenu(MenuType<?> type, int pContainerId, Inventory inventory) {
        super(type, pContainerId);
        this.inventory = inventory;
        invHandler = new InvWrapper(inventory);
    }

    protected void playerInventory() {
