...
public class DevRegistry {
    private static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, Millennium.ID);
    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Millennium.ID);
    private static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, Millennium.ID);


    public static final AllInOneObject SHIP_BLOCK = register(new AllInOneObject("ship_block",
            new ResourceLocation(Millennium.ID, "models/gltf/ship.gltf")));

    public static final AllInOneObject VEHICLE_BLOCK = register(new AllInOneObject("vehicle_block",
            new ResourceLocation(Millennium.ID, "models/gltf/vehicle.gltf")));

    public static final AllInOneObject PLACEHOLDER_BLOCK = register(new AllInOneObject("placeholder_block",
            new ResourceLocation(Millennium.ID, "models/gltf/placeholder.gltf")));

    public static final AllInOneObject KITCHENETTE_BLOCK = register(new AllInOneObject("kitchenette_block",
            new ResourceLocation(Millennium.ID, "models/gltf/kit/kitchenette.gltf")));

    public static final AllInOneObject MERCEDES_BLOCK = register(new AllInOneObject("mercedes_block",
            new ResourceLocation(Millennium.ID, "models/gltf/mercedes/mercedes.gltf")));
    ...
    private static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS =
            DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS, Millennium.ID);

    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES =
            DeferredRegister.create(Registry.RECIPE_TYPE.key(), Millennium.ID);
