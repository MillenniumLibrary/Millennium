package tt432.millennium.client.modernui.component.view;
...
public class HorizontalScrollView extends FrameLayout {
    ...
    void moveAction(MotionEvent ev) {
    ...
    void downAction(MotionEvent ev) {
        final int x = (int) ev.getX();
    ...
    public boolean onInterceptTouchEvent(@Nonnull MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE -> moveAction(ev);
            case MotionEvent.ACTION_DOWN -> downAction(ev);
            case MotionEvent.ACTION_CANCEL, MotionEvent.ACTION_UP -> cancelAction();
    ...
    public void onDrawForeground(@Nonnull Canvas canvas) {
        ...
        boolean leftFinished = mEdgeGlowLeft.isFinished();
        boolean rightFinished = mEdgeGlowRight.isFinished();
